  ...
  <div>
    <Head>
      <meta charset="utf-8"/>
          ...
          <link rel="stylesheet" href="/static/css/timeline.css"></link>
          <link rel="stylesheet" href="/static/css/animate.css"></link>
          <link rel="stylesheet" href="/static/css/nav.css"></link>
          <link rel="stylesheet" href="/static/css/jquery.fancybox.css"></link>

          <link rel="stylesheet" href="/static/css/style.css"></link>
          <link rel="stylesheet" href="/static/css/responsive.css"></link>
      ...
      <div className="body">
            ...
            <div className="container">
                  <div className="row">
                      <div className="top-contact col m12 s12 right">
                          <span><i className="fa fa-envelope"></i> <a href="mailto:">miras.federico@gmail.com</a></span>
                          <span><i className="fa fa-phone"></i> <a href="tel:">+5491166300062 </a></span>
                      </div>
                  </div>
              </div>
                            <div id="header-bottom" className="z-depth-1">                   <div id="sticky-nav">
                      <div className="container">
                          <div className="row">
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2> <i className="fa fa-gears"></i>Skills</h2>
                      </div>
                  ...
                  <div className="row">
                      ...
                      <div id="cd-timeline" className="cd-container">
                  		<div className="cd-timeline-block wow fadeIn a2" data-wow-delay="0.2s">
                  			...
                  			</div>                   			<div className="cd-timeline-content col m5 s12 z-depth-1">
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2><i className="fa fa-th-list"></i>Portfolio</h2>
                      </div>
                      ...
                      <div className="screenshots" id="portfolio-item" >
                          <div className="row">
                              <ul className="grid">
                                    ...
                                    <div className="sa-project-gallery-view" id="project-gallery-view"></div>
                  <div className="back-btn col s12">
                      <a id="back-button" className="btn btn-info waves-effect" href="#" ><i className="fa fa-long-arrow-left"></i> Go Back </a>
                  </div>
          ...
          <section id="education">
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2> <i className="fa fa-edit"> </i>Blog</h2>
                      </div>
                      <div className="row">
                          <div className="blog">
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2> <i className="fa  fa-money "></i>Pricing Table </h2>
                      </div>
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2> <i className="fa fa-quote-left"></i>Clients</h2>
                      </div>
              ...
              <div className="container">
                  <div className="row">
                      <div className="section-title wow fadeIn a1" data-wow-delay="0.1s">
                          <h2> <i className="fa fa-send"></i>Contact</h2>
                      </div>
                          ...
                          <div className="row">
                              <form id="contactForm" d>
                                  ...
                                  <div className="input-field col m6 s12 wow fadeIn a2" data-wow-delay="0.2s">
                                      <label for="name" className="h4">Full Name *</label>
                                      <input type="text" className="form-control validate" id="name" required data-error="NEW ERROR MESSAGE"/>
                                  </div>
                                  <div className="input-field col m6 s12 wow fadeIn a4" data-wow-delay="0.4s">
                                      <label for="email" className="h4">Email *</label>
                                      <input type="email" className="form-control validate" id="email"  required/>
                                  </div>
                                  <div className="input-field col m6 s12 wow fadeIn a3" data-wow-delay="0.3s">
                                      <label for="last_name" className="h4">Subject *</label>
                                      <input type="text" className="form-control validate" id="last_name" required/>
                                  </div>
                                  ...
                                  <div className="input-field col m12 s12 wow fadeIn a6" data-wow-delay="0.6s">
                                      <label for="message" className="h4 ">Message *</label>
                                      <textarea id="message" className="form-control materialize-textarea validate" required></textarea>
                                  </div>
                      ...
                      <div className="interests col s12 m12 l12 wow fadeIn" data-wow-delay="0.1s">
                          <div className="row">
                              <ul className="z-depth-1">                                   <li><i className="fa fa-facebook-official tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Facebook"></i></li>
                                  <li><i className="fa fa-twitter tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Twitter"></i></li>
                                  <li><i className="fa fa-linkedin tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="linkedin"></i></li>
                                  <li><i className="fa fa-whatsapp tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Whatsapp"></i></li>
                                  <li><i className="fa fa-youtube tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Youtube"></i></li>
                                  <li><i className="fa fa-vimeo tooltipped col m2 s6" data-position="top" data-delay="50" data-tooltip="Vimeo"></i></li>
                              </ul>                           </div>
                      </div>
                  </div>
              </div>
